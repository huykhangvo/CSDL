...
-- Thời gian đã tạo: Th10 23, 2021 lúc 10:19 AM
...
(1, 'admin', '02092000@gmail.com', 'c4ca4238a0b923820dcc509a6f75849b', 'Võ Huy Khang', 1, '2021-11-23 09:28:37', 2, 'admin_0a2a7ff3f08ea2f5_4c4c60f88be6b996_3450816334417691769722.jpg', '2000-09-02'),
...
(13, 'MyXuyen', '18004160@student.vlute.edu.vn', 'e10adc3949ba59abbe56e057f20f883e', 'Huỳnh Thị Mỹ Xuyên', 1, '2021-11-23 09:13:44', 2, 'avatar-default.jpg', '1997-01-01');
...
(1, 1, 1, '<p><strong>“Nước ta đã ra khỏi khủng hoảng kinh tế - xã hội nhưng một số mặt còn chưa vững chắc” là đánh giá tổng quát của Đại hội nào ?  </strong></p>', '<p>Đại hội VII (6/1991)</p>', '<p>Đại hội VI (12/1986)</p>', '<p>Đại hội VIII (7/1996)</p>', '<p>Đại hội IX (4/2001)</p>', '<p>Đại hội VIII (7/1996)</p>', 170, 1, 'QuocMinh', 4),
...
(1, 4, 1, '<p><strong>“Nước ta đã ra khỏi khủng hoảng kinh tế - xã hội nhưng một số mặt còn chưa vững chắc” là đánh giá tổng quát của Đại hội nào ?  </strong></p>', '<p>Đại hội VII (6/1991)</p>', '<p>Đại hội VI (12/1986)</p>', '<p>Đại hội VIII (7/1996)</p>', '<p>Đại hội IX (4/2001)</p>', '<p>Đại hội VIII (7/1996)</p>', 329, 1, 'admin', 4),
(1, 4, 1, '<p><strong>Nhìn lại chặng đường 10 năm đổi mới (1986-1996), Đại hội Đại biểu toàn quốc lần thứ VIII của Đảng nhận định như thế nào về tình hình đất nước ta ?</strong></p>', '<p>Nước ta đã có nền kinh tế phát triển</p>', '<p>Nước ta đã thoát ra khỏi khủng hoảng kinh tế - xã hội</p>', '<p>Nước ta đã chuyển sang nền kinh tế thị trường</p>', '<p>Nước ta đã thoát khỏi nghèo đói, có dự trữ và bước đầu có xuất khẩu</p>', '<p>Nước ta đã chuyển sang nền kinh tế thị trường</p>', 330, 1, 'admin', 4),
(1, 4, 1, '<p><strong>Đại hội Đảng lần thứ IX (4/2001) xác định quan điểm phát triển nhanh và bền vững, theo đó tăng trưởng kinh tế phải đi đôi với vấn đề gì ?</strong></p>', '<p>Thực hiện tiến bộ, công bằng xã hội và bảo vệ môi trường</p>', '<p>Chính sách xã hội</p>', '<p>Tăng cường sự quản lý của Nhà nước</p>', '<p>Phát triển kinh tế tri thức</p>', '<p>Thực hiện tiến bộ, công bằng xã hội và bảo vệ môi trường</p>', 331, 1, 'admin', 4),
(1, 4, 1, '<p><strong>Trong bốn nguy cơ mà Đảng ta đã chỉ ra thì nguy cơ nào là lớn nhất trong 5 năm sắp tới (2016-2020)</strong></p>', '<p>Tụt hậu xa hơn về kinh tế so với các nước trong khu vực và trên thế giới</p>', '<p>Suy thoái về tư tưởng chính trị, đạo đức, lối sống của một bộ phận cán bộ, đảng viên, công chức, viên chức</p>', '<p>Tham nhũng, quan liêu, lãng phí</p>', '<p>Diễn biến hóa bình</p>', '<p>Tụt hậu xa hơn về kinh tế so với các nước trong khu vực và trên thế giới</p>', 332, 1, 'admin', 4),
(1, 4, 1, '<p><strong>Hội nghị Trung ương 7 (3/2003), khóa IX đã đề ra bao nhiêu Nghị quyết quan trọng, đó là những Nghị quyết gì ?</strong></p>', '<p>Ba Nghị quyết : Nghị quyết về phát huy sức mạng đại đoàn kết toàn dân tộc; Nghi quyết về công tác dân tộc; Nghi quyết về công tác tôn giáo</p>', '<p>Một Nghị quyết: Nghị quyết về nâng cao năng lực lãnh đạo và sức chiến đấu của Đảng</p>', '<p>Không có Nghị quyết nào quan trọng</p>', '<p>Hai Nghị quyết: Nghị quyết về công tác dân tộc; Nghị quyết về công tác tôn giáo</p>', '<p>Ba Nghị quyết : Nghị quyết về phát huy sức mạng đại đoàn kết toàn dân tộc; Nghi quyết về công tác dân tộc; Nghi quyết về công tác tôn giáo</p>', 333, 1, 'admin', 4),
(1, 4, 1, '<p><strong>Đặc trương đầu tiên của mô hình xã hội xã hội chủ nghĩa ở Việt Nam trong \"Cương lĩnh xây dựng đất nước trong thời kỳ quá độ lên chủ nghĩa xã hội\" (Bổ sung, Phát triển năm 2011) là gì ?</strong></p>', '<p>Có Nhà nước pháp quyền xã hội chủ nghĩa của nhân dân, do nhân dân vì nhân dân</p>', '<p>Do nhân dân làm chủ</p>', '<p>Dân giàu, nước mạnh, dân chủ, công bằng, văn minh</p>', '<p>Có nền văn hoá tiên tiến, đậm đà bản sắc dân tộc</p>', '<p>Dân giàu, nước mạnh, dân chủ, công bằng, văn minh</p>', 334, 1, 'admin', 4),
(1, 4, 1, '<p><strong>Cương lĩnh xây dựng đất nước trong thời kỳ quá độ lên chủ nghĩa xã hội bổ sung và phát triển năm 2011 đã xác định: “Xã hội xã hội chủ nghĩa mà nhân dân ta xây dựng là một xã hội” như thế nào ?</strong></p>', '<p>Có một nền kinh tế phát triển cao dựa trên lực lượng sản xuất hiện đại và quan hệ sản xuất phù hợp</p>', '<p>Do nhân dân lao động làm chủ</p>', '<p>Do nhân dân làm chủ</p>', '<p>Văn hoá là nền tảng tinh thần của xã hội</p>', '<p>Do nhân dân làm chủ</p>', 335, 1, 'admin', 4),
(1, 4, 1, '<p><strong> Trọng tâm của đổi mới hệ thống chính trị được nêu ra tại Hội nghị Trung ương 6 (3/1989) là gì ?</strong></p>', '<p>Đổi mới tổ chức và phương thức hoạt động của hệ thống chính trị</p>', '<p>Đổi mới hoạt động của các đoàn thể</p>', '<p>Đổi mới tổ chức nâng cao hiệu lực quản lý của nhà nước</p>', '<p>Đổi mới tổ chức và phương thức hoạt động lãnh đạo của Đảng</p>', '<p>Đổi mới tổ chức và phương thức hoạt động của hệ thống chính trị</p>', 336, 1, 'admin', 4);
...
(20, '18004160', '18004160@student.vlute.edu.vn', 'e10adc3949ba59abbe56e057f20f883e', 'Huỳnh Thị Mỹ Xuyên', 3, 1, '2021-11-23 09:11:23', 3, 'avatar-default.jpg', '2000-11-27', NULL, NULL, '35:55');
...
--
ALTER TABLE `questions`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=337;
