...
--Khôi phục dữ liệu
UPDATE MatHang set isDeleted = 0
UPDATE LoaiPhong set isDeleted = 0
UPDATE Phong set isDeleted = 0
UPDATE DonViTinh set isDeleted = 0
UPDATE MatHang set isDeleted = 0
UPDATE NhaCungCap set isDeleted = 0
UPDATE NhanVien set isDeleted = 0
